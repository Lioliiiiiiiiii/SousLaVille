...
namespace SousLaVille.EditorTools
{
    ...
    public static class UndergroundLayout
    {
        ...
        /// <summary>
        /// Panneau de carrefour, phase 12c. Le sous-sol n'avait AUCUN repere, et la carte est
        /// passee de 1200 a 2880 cases : sa fleche montre la station. Douze carrefours releves
        /// par calcul sur le plan, puis choisis a la main, un par secteur.
        /// </summary>
